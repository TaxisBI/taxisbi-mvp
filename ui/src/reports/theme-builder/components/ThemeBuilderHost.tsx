...
import type { ThemeBuilderController } from '../../../theme/useThemeBuilder';
import type { ThemeSaveDraft } from '../../../theme/types';

type ThemeBuilderHostProps = {
  builder: ThemeBuilderController;
...
export default function ThemeBuilderHost({
  builder,
  onBackToLanding,
  onBackToReport,
  canBackToReport,
  ...
  return (
    ...
    >
      ...
      <ThemeBuilderWorkspace
        ...
        onUpdateThemeSaveDraft={onUpdateThemeSaveDraft}
