...
const DEFAULT_UI_THEME: ResolvedUiTheme = {
  ...
  axisTickWidth: 1,
  axisDomainWidth: 1,
  legendSymbolSize: 140,
  legendSymbolStrokeWidth: 1,
  legendLabelLimit: 220,
  legendRowPadding: 4,
  legendColumnPadding: 12,
  legendOrient: 'right',
  axisLabelAngle: 0,
  axisLabelLimit: 180,
  axisLabelPadding: 6,
  axisLabelOverlapStrategy: 'parity',
  axisNumberFormat: ',.2f',
  axisDateFormat: '%Y-%m-%d',
  xAxisGridEnabled: 1,
  yAxisGridEnabled: 1,
  chartPointShape: 'circle',
  chartPointSize: 70,
  chartPointOpacity: 1,
  chartAreaOpacity: 0.2,
  chartLineInterpolate: 'linear',
  referenceLineColor: '#64748b',
  referenceLineWidth: 2,
  referenceLineDashStyle: 'solid',
  referenceLineLabelColor: '',
  referenceLineLabelFontSize: 12,
  chartSeriesSelectedColor: '',
  chartSeriesSelectedOpacity: 1,
  chartSeriesMutedColor: '#94a3b8',
  chartSeriesMutedOpacity: 0.45,
  chartSeriesInactiveOpacity: 0.2,
  overlapPalette: [],
  tooltipTheme: 'light',
  tooltipStyle: {
    fillColor: '',
