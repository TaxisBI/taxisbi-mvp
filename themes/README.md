...
- `themes/3_rulebook/<DOMAIN>/<rulebook>/`: rulebook-level themes.
...
- rulebook theme: `{ "domain": ["AR"], "rulebook": ["Receivable_item"] }`
- Chart-specific theme: `{ "domain": ["AR"], "rulebook": ["Receivable_item"], "chart": ["aging_by_bucket"] }`
